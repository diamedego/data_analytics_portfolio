...
Data preparation was performed in MySQL Workbench. 
Key tasks included date standardization, duplicate detection and consolidation, null and out-of-range value treatment and cross-table referential integrity validation. 
All corrections were grounded in physical coherence criteria — for example, removing pre-installation production records and flagging energy or cost values outside operationally valid ranges.
